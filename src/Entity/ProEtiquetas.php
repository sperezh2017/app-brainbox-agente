...
use App\Repository\ProEtiquetasRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: ProEtiquetasRepository::class)]
class ProEtiquetas
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToMany(mappedBy: 'etiqueta', targetEntity: ProTransaccion::class)]
    ...
    public function addProTransaccion(ProTransaccion $proTransaccion): static
    {
        if (!$this->proTransaccions->contains($proTransaccion)) {
            ...
            $proTransaccion->setEtiqueta($this);
        }
    ...
    public function removeProTransaccion(ProTransaccion $proTransaccion): static
    {
        if ($this->proTransaccions->removeElement($proTransaccion)) {
            ...
            if ($proTransaccion->getEtiqueta() === $this) {
                $proTransaccion->setEtiqueta(null);
            }
        }
